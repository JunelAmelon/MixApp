...
class ClientController extends AbstractController
{
    ...
    #[Route('/{id}/projets', name: 'client_projets')]
    public function projets(Client $client): Response
    {
        // Récupérer tous les projets associés à ce client
        $projets = $client->getProjets();

        // Maintenant, vous pouvez faire quelque chose avec les projets récupérés, par exemple, les transmettre à un template pour affichage
